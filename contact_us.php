      ...
      <div class="col-md-6">
        ...
        <form action="contact_db.php" method="POST">
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <input type="number" name="phno" class="form-control mt-2" placeholder="Phone Number" required>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <textarea class="form-control" name="textarea" id="exampleFormControlTextarea1" placeholder="Enter Your Query Here" rows="3" required></textarea>
              </div>
            </div>
            <div class="col-12">
            <div class="form-group">
