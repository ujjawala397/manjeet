...
<hr>
	...
	<?php 
		if(isset($_POST['sendmail'])) {
			...
			$mail->Body    = '<div>Truck booking is done on <p id="date"></p> </div>';
    ...
    <div class="col-md-9 col-md-offset-2">
        <form role="form" method="post" enctype="multipart/form-data">
             ...
             <div class="row">
	            <div class="col-sm-9 form-group">
	                <label for="subject">Enter date and time:</label>
	                <input type="text" class="form-control" id="hello">
	            </div>
            </div>
            <script>
            	function myFunction()
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-sm-9 form-group">
                    <button onclick="myFunction()" type="submit" name="sendmail" class="btn btn-lg btn-success btn-block">Book Now</button>
                </div>
            </div>
        </form>
	</div>
